...
class Header extends \Opencart\System\Engine\Controller {
	public function index(): string {
		...
		$data['dropdown'] = 'catalog/view/stylesheet/dropdown.css';
		$data['mains'] = 'catalog/view/stylesheet/style.css';
		$data['adaptive'] = 'catalog/view/stylesheet/media.css'; 

		// Hard coding scripts so they can be replaced via the event's system.
		$data['jquery'] = 'catalog/view/javascript/jquery/jquery-3.6.0.min.js';

		//$data['dropdown'] = 'catalog/view/javascript/dropdown.js';
		$data['m_index'] = 'catalog/view/javascript/m_index.js';
